...
export default function ConscienciaHeader() {
  return (
    <div aria-hidden="false" style={{
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 14, textAlign: 'center' }}>
        <TomorrowlandMark color={goldLit} style={{ width: 18, height: 18, marginBottom: 5, filter: 'drop-shadow(0 1px 6px rgba(6,9,24,0.8))' }} />
        <h2 style={{ ...display, fontSize: 'clamp(21px, 7vw, 27px)', fontWeight: 700, letterSpacing: '0.01em', lineHeight: 1, color: goldLit, textShadow: '0 1px 12px rgba(6,9,24,0.85)', fontVariationSettings: '"SOFT" 30, "opsz" 144', margin: 0, whiteSpace: 'nowrap' }}>Consciencia</h2>
        <div style={{ ...mono, fontSize: 9, fontWeight: 700, letterSpacing: '0.28em', color: 'rgba(242,236,220,0.92)', marginTop: 6, textShadow: '0 1px 6px rgba(6,9,24,0.7)' }}>TOMORROWLAND · BELGIUM 2026</div>
      </div>
    </div>
  );
}
