  ...
  return (
    <div aria-hidden="false" style={{
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <TomorrowlandMark color={goldLit} style={{ width: 22, height: 22, marginBottom: 5, filter: 'drop-shadow(0 1px 6px rgba(6,9,24,0.8))' }} />
        <h2 style={{ ...display, fontSize: 'clamp(24px, 8vw, 32px)', fontWeight: 700, letterSpacing: '0.01em', lineHeight: 1, color: goldLit, textShadow: '0 1px 12px rgba(6,9,24,0.85)', fontVariationSettings: '"SOFT" 30, "opsz" 144', margin: 0, whiteSpace: 'nowrap' }}>Consciencia</h2>
