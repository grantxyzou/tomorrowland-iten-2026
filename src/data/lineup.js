...
export const LINEUP = {
  fri: {
    ...
    'Planaxis': [
      ...
      { name: 'Mad Maxx', start: '22:30', end: '23:30' },
    ...
    'Melodia by Corona': [
      ...
      { name: 'Da Capo B2B Caiiro B2B Enoo Napa', start: '22:00', end: '23:30' },
    ...
    'Atmosphere': [
      ...
      { name: 'Sara Landry', status: 'new', start: '23:00', end: '00:30' },
    ...
    'Core': [
      ...
      { name: 'Modeselektor (DJ Set)', start: '23:00', end: '01:00' },
    ...
    'The Great Library': [
      ...
      { name: 'Hardwell B2B Sub Zero Project', start: '00:00', end: '01:00' },
  ...
  sat: {
    'Mainstage': [
      ...
      { name: 'Fisher', start: '21:15', end: '22:20' },
      { name: 'Halō', start: '18:10', end: '19:10' },
      { name: 'John Newman', start: '20:10', end: '21:15' },
      { name: 'Maddix', start: '17:05', end: '18:10' },
      'MC Stretch',
      { name: 'Merow', start: '14:00', end: '15:00' },
      { name: 'Omdat Het Kan & Average Rob', start: '16:00', end: '17:05' },
      { name: 'Stephani B', start: '15:00', end: '16:00' },
    ],
    'Freedom by Bud': [
      { name: 'Armin van Buuren', start: '22:00', end: '00:00' },
    ...
    'Planaxis': [
      ...
      { name: 'Steve Aoki', start: '23:00', end: '00:00' },
    ],
    'Melodia by Corona': [
  ...
  sun: {
    'Mainstage': [
      ...
      { name: 'John Summit', start: '20:40', end: '21:45' },
      { name: 'Kevin de Vries', start: '17:35', end: '18:40' },
      { name: 'Malugi', start: '16:30', end: '17:35' },
      'MC Stretch',
    ...
    'Freedom by Bud': [
      ...
      { name: 'I Hate Models', start: '22:00', end: '00:00' },
    ...
    'The Rose Garden': [
      ...
      { name: 'The Saints', start: '22:00', end: '23:30' },
    ...
    'Atmosphere': [
      { name: 'Amelie Lens', start: '22:30', end: '01:00' },
    ...
    'The Great Library': [
      ...
      { name: 'Vini Vici', start: '23:00', end: '01:00' },
